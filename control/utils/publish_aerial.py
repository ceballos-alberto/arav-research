...
waypointTopic = "/arav/path_planning/output/path_aerial"
...
aerialActivatorPub = rospy.Publisher (aerialActivatorTopic, Bool, queue_size=1)
...
activateAerial = Bool ()
activateAerial.data = True
aerialActivatorPub.publish(activateAerial)
